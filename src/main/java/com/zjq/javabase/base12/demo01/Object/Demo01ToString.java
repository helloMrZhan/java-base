 ...
 *
 * 由于toString方法返回的结果是内存地址，而在开发中，经常需要按照对象的属性得到
 * 相应的字符串表现形式，因此也需要重写它。
 * @author zjq
 */
public class Demo01ToString{
    public static void main(String[] args) {
        ...
        String s = p.toString();
        System.out.println(s);//com.zjq.javabase.base12.demo01.Object.Person@75412c2f | abc | Person{name=张三 ,age=18}

        //直接打印对象的名字,其实就是调用对象的toString  p=p.toString();
        System.out.println(p);//com.zjq.javabase.base12.demo01.Object.Person@5f150435 | abc | Person{name=张三 ,age=18}
